...
5. To see the source code of components (only the ones which are programmed) double click on them. 
6. You can change the code and connect a panel to their outputs for debugging messages. 
